...
var ToolsController = {
  ...
  doCommand : function(cmd) {
    switch (cmd) {
      case "cmd_options":
      {
        window.openDialog("chrome://emepro/content/options.xul", "options", "centerscreen,modal");
        break;
      }
    }
  }
...
var HelpController = {
  ...
  doCommand : function(cmd) {
    switch (cmd) {
      case "cmd_about":
      {
        window.openDialog("chrome://emepro/content/about.xul", "about", "centerscreen,modal");
        break;
      }
    }
  }
